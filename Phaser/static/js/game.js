...
function create() {
  ...
  // HUD
  scoreText = this.add.text(16, 16, 'Tu puntuación: 0', {
    fontSize: '24px',
    fill: '#fff'
  });

  // Instrucciones
  this.add.text(800 - 16, 16, '← → movimiento   ↑ salto', {
    fontSize: '16px',
    fill: '#ffffff'
  }).setOrigin(1, 0);
}
...
function collectStar(player, star) {
  ...
  score += 10;
  scoreText.setText('Tu puntuación: ' + score);
...
function hitBomb(player, bomb) {
  ...
  const txt = this.add.text(400, 300, '💥 Perdiste\nPresiona R para reiniciar el juego', {
    fontSize: '28px',
    fill: '#fff',
    align: 'center'
  }).setOrigin(0.5);
